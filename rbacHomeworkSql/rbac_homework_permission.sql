...
CREATE TABLE `permission` (
  ...
  `permission_name` varchar(45) COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `permission` VALUES (1,'read','able to read messages'),(2,'write','able to write messages'),(3,'manage','manage posts'),(4,'seePublisherId','able to see publisher\'s ID');
